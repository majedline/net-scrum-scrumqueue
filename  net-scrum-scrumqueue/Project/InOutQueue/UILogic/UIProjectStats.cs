...
{
    public partial class UIProjectStats : Form
    {
        public UIProjectStats()
        {
            InitializeComponent();
        }
        public UIProjectStats(int projectId)
        {
            InitializeComponent();
            this.init(projectId);
        }
        ...
        {
            List<BussinessLogic.SystemStat> li = BussinessLogic.SystemStat.GetProjectStats(projectID);

            string x = "";
            foreach (BussinessLogic.SystemStat s in li)
            {
                x = x + s.ToString() + "\r\n";
            }
